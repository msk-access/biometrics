...
class Genotyper:
    ...
    def _compute_discordance(self, samples):
        ...
        row['HomozygousMismatch'] = sum((reference_sample.pileup['genotype_class'] != query_sample.pileup['genotype_class']) & ((reference_sample.pileup['genotype_class'] == 'Hom') | (query_sample.pileup['genotype_class'] == 'Hom')))
